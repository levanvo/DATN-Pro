...
import { useGetAllOrdersQuery, useGetOneOrdersQuery, useGetUserOrdersQuery, useUpdateOrderMutation } from '../Services/Api_Order';
...
const BillDetailHome = () => {
    ...
    const { data: user } = useGetOneUserQuery(data?.data?.userId)
